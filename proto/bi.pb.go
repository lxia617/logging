...
func (m *BiLog) String() string { return proto1.CompactTextString(m) }
...
func (m *BiResult) String() string { return proto1.CompactTextString(m) }
...
func (c *misBiClient) Bi(ctx context.Context, in *BiLog, opts ...grpc.CallOption) (*BiResult, error) {
	out := new(BiResult)
	err := grpc.Invoke(ctx, "/proto.MisBi/Bi", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil

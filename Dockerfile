...
#RUN go run /go/src/github.com/MISingularity/logging/be/cmd/main.go
...
RUN go run /go/src/github.com/MISingularity/logging/be/cmd/main.go -mongo-host $MONGO_SERVICE_HOST -mongo-port $MONGO_SERVICE_PORT
EXPOSE 50051
